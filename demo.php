...
<body>
    ...
    <style type="text/css">
        ...
        .outer .lg-ogo {
            background: url(https://falconfxtradings.com/img/logo_en_200.html) 10px center no-repeat #f2f2f2;
            background-size: 25%;
        }
    ...
    <div class="block-charts theme-new-btn" id="chart-holder">
            ...
            <div class="mini-chart-wrap">
                <div class="deal-finish-popup">
                    <div class="deal-finish-popup-win">
                        <h2 class="dfp-head">
                            Congratulations! You predicted the
                            market and earned $19!
                        </h2>
                        <p class="dfp-body"></p>
                        <div class="dfp-foot">
                            <a class="link_out" target="_parent" href="Dashboard/register">
                                <div class="left-foot">
                            ...
                            <a class="restart" id="restart"><i class="fa fa-refresh"></i><span>New
                                    forecast</span></a>
                        </div>
                    </div>
                ...
                <div class="mini-chart-legend">
                    <div class="mc-table lg-ogo">
                        <div class="mc-table-td mc-logo-empty">
                        </div>
                        <div class="mc-table-td mc-table-td_price" data-style="width: 30%;">
                            <div class="mc-table-td-legend">
                                Price
                            </div>
                            <div class="mc-table-td-value">
                                $10
                            </div>
                        </div>
                ...
                <div class="mini-chart-btn-cont">
                    ...
                    <button class="mc-btn mc-btn_call" id="btn_call">
                        <img class="svg-ico-call" src="404.html">
                        <span><i class="arrow-up"></i> Will
                            go<b>up</b></span>
                    </button>
                    <button class="mc-btn mc-btn_put" id="btn_put">
                        <img class="svg-ico-put" src="404.html">
                        <span><i class="arrow-down"></i> Will
                            go<b>down</b></span>
                    </button>
                    <div class="wait-deal-end">
                        <div class="wde-legend">
                            Wait for trade close:
                        </div>
                        <div class="wde-timer-cont">
                            <div class="chart-timer">
                                <i><img class="svg-ico-call" src="404.html"></i><span class="chart-time-self">00:08</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="mini-chart-cont">
                    <div class="chart-padding">
                        <div id="chart1" class="chart">
                            ...
                            <div width="490" height="254" style=" height: 254px;width: 490px;vertical-align: top;margin-bottom: -10px;" id="chart-m"></div>
            ...
            <div class="deal-finish-popup-win">
                ...
                <div class="dfp-foot">
                    <a class="link_out" target="_parent" href="Dashboard/register">
                        ...
                        <div class="right-foot">
                            <span>Open an account</span>, and
                            start trading now!
                        </div>
                    </a>
                    <a class="restart" id="restart-chart"><i class="fa fa-refresh"></i><span>New
                            forecast</span></a>
                </div>
            </div>
            <div class="deal-finish-popup-lose">
    ...
    <script type="text/javascript">
        ...
        (function(global, factory) {
            ...
            // locale key.
            function locale_locales__getSetGlobalLocale(
                key,
                values
            ) {
                var data;
            ...
            function expandFormat(format, locale) {
                ...
                function replaceLongDateFormatTokens(
                    input
                ) {
                    return (
            ...
            function configFromISO(config) {
                var i,
                    ...
                    string = config._i,
                    match =
                    from_string__isoRegex.exec(string);

                if (match) {
                    getParsingFlags(config).iso = true;
                    for (
                        i = 0, l = isoDates.length; i < l; i++
                    ) {
            ...
            function configFromString(config) {
                var matched = aspNetJsonRegex.exec(
                    config._i
                );
                ...
                if (config._isValid === false) {
                    ...
                    utils_hooks__hooks.createFromInputFallback(
                        config
                    );
                }
            }
            ...
            addParseToken(
                ...
                function(input, array) {
                    array[YEAR] =
                        input.length === 2 ?
                        utils_hooks__hooks.parseTwoDigitYear(
                            input
                        ) :
                        toInt(input);
                }
            ...
            function weekOfYear(
                ...
                adjustedMoment = local__createLocal(
                    mom
                ).add(daysToDayOfWeek, "d");
                return {
                    week: Math.ceil(
                        adjustedMoment.dayOfYear() / 7
                    ),
            ...
            function dayOfYearFromWeekInfo(config) {
                ...
                if (
                    ...
                    weekYear = defaults(
                        w.GG,
                        config._a[YEAR],
                        weekOfYear(local__createLocal(), 1, 4)
                        .year
                    );
                    week = defaults(w.W, 1);
            ...
            var add_subtract__add = createAdder(
                1,
                "add"
            );
            var add_subtract__subtract = createAdder(
                -1,
                "subtract"
            );

            function moment_calendar__calendar(
                time,
                formats
            ) {
            ...
            var token;
            for (
                token = "SSSS"; token.length <= 9; token += "S"
            ) {
            ...
            for (
                token = "S"; token.length <= 9; token += "S"
            ) {
            ...
            momentPrototype__proto.add =
                add_subtract__add;
            momentPrototype__proto.calendar =
            ...
            momentPrototype__proto.invalidAt =
                invalidAt;
            momentPrototype__proto.isAfter = isAfter;
            momentPrototype__proto.isBefore = isBefore;
            momentPrototype__proto.isBetween =
                isBetween;
            momentPrototype__proto.isSame = isSame;
            momentPrototype__proto.isValid =
                moment_valid__isValid;
            momentPrototype__proto.lang = lang;
            momentPrototype__proto.locale = locale;
            momentPrototype__proto.localeData =
                localeData;
            momentPrototype__proto.max = prototypeMax;
            momentPrototype__proto.min = prototypeMin;
            momentPrototype__proto.parsingFlags =
                parsingFlags;
            momentPrototype__proto.set = getSet;
            momentPrototype__proto.startOf = startOf;
            momentPrototype__proto.subtract =
            ...
            momentPrototype__proto.valueOf =
                to_type__valueOf;

            // Year
            momentPrototype__proto.year = getSetYear;
            momentPrototype__proto.isLeapYear =
                getIsLeapYear;

            // Week Year
            momentPrototype__proto.weekYear =
                getSetWeekYear;
            momentPrototype__proto.isoWeekYear =
                getSetISOWeekYear;

            // Quarter
            momentPrototype__proto.quarter =
                momentPrototype__proto.quarters =
                getSetQuarter;

            // Month
            momentPrototype__proto.month = getSetMonth;
            momentPrototype__proto.daysInMonth =
                getDaysInMonth;

            // Week
            momentPrototype__proto.week =
                momentPrototype__proto.weeks = getSetWeek;
            momentPrototype__proto.isoWeek =
                momentPrototype__proto.isoWeeks =
                getSetISOWeek;
            momentPrototype__proto.weeksInYear =
                getWeeksInYear;
            momentPrototype__proto.isoWeeksInYear =
                getISOWeeksInYear;

            // Day
            momentPrototype__proto.date =
                getSetDayOfMonth;
            momentPrototype__proto.day =
                momentPrototype__proto.days =
                getSetDayOfWeek;
            momentPrototype__proto.weekday =
                getSetLocaleDayOfWeek;
            momentPrototype__proto.isoWeekday =
                getSetISODayOfWeek;
            momentPrototype__proto.dayOfYear =
                getSetDayOfYear;

            // Hour
            momentPrototype__proto.hour =
                momentPrototype__proto.hours = getSetHour;

            // Minute
            momentPrototype__proto.minute =
                momentPrototype__proto.minutes =
                getSetMinute;

            // Second
            momentPrototype__proto.second =
                momentPrototype__proto.seconds =
                getSetSecond;
            ...
            // Offset
            momentPrototype__proto.utcOffset =
                getSetOffset;
            momentPrototype__proto.utc = setOffsetToUTC;
            momentPrototype__proto.local =
                setOffsetToLocal;
            ...
            momentPrototype__proto.isUtcOffset =
                isUtcOffset;
            momentPrototype__proto.isUtc = isUtc;
            momentPrototype__proto.isUTC = isUtc;

            // Timezone
            momentPrototype__proto.zoneAbbr =
                getZoneAbbr;
            momentPrototype__proto.zoneName =
                getZoneName;
            ...
            function locale_calendar__calendar(
                key,
                mom,
                now
            ) {
            ...
            prototype__proto.longDateFormat =
                longDateFormat;
            prototype__proto._invalidDate =
                defaultInvalidDate;
            prototype__proto.invalidDate = invalidDate;
            prototype__proto._ordinal = defaultOrdinal;
            prototype__proto.ordinal = ordinal;
            prototype__proto._ordinalParse =
                defaultOrdinalParse;
            prototype__proto.preparse =
                preParsePostFormat;
            prototype__proto.postformat =
                preParsePostFormat;
            prototype__proto._relativeTime =
                defaultRelativeTime;
            prototype__proto.relativeTime =
            ...
            prototype__proto._months =
                defaultLocaleMonths;
            prototype__proto.monthsShort =
                localeMonthsShort;
            prototype__proto._monthsShort =
            ...
            prototype__proto.firstDayOfYear =
                localeFirstDayOfYear;
            prototype__proto.firstDayOfWeek =
                localeFirstDayOfWeek;

            // Day of Week
            prototype__proto.weekdays = localeWeekdays;
            prototype__proto._weekdays =
                defaultLocaleWeekdays;
            prototype__proto.weekdaysMin =
                localeWeekdaysMin;
            prototype__proto._weekdaysMin =
                defaultLocaleWeekdaysMin;
            prototype__proto.weekdaysShort =
                localeWeekdaysShort;
            ...
            function lists__get(
                ...
                var utc = create_utc__createUTC().set(
                    setter,
                    index
                );
            ...
            function lists__listMonthsShort(
                format,
                index
            ) {
                return list(
            ...
            function duration_add_subtract__addSubtract(
                ...
                var other = create__createDuration(
                    input,
                    value
                );
            ...
            function duration_add_subtract__add(
                input,
                value
            ) {
            ...
            function duration_add_subtract__subtract(
                input,
                value
            ) {
                return duration_add_subtract__addSubtract(
            ...
            function as(units) {
                ...
                if (
                    ...
                    days =
                        this._days +
                        Math.round(
                            monthsToDays(this._months)
                        );
                    switch (units) {
                        case "week":
                            return (
                                days / 7 + milliseconds / 6048e5
                            );
                        case "day":
                            return days + milliseconds / 864e5;
                        case "hour":
                            return (
                                days * 24 + milliseconds / 36e5
                            );
                        case "minute":
                            return (
                                days * 1440 + milliseconds / 6e4
                            );
                        case "second":
                            return (
            ...
            duration_prototype__proto.abs =
                duration_abs__abs;
            duration_prototype__proto.add =
                duration_add_subtract__add;
            duration_prototype__proto.subtract =
                duration_add_subtract__subtract;
            duration_prototype__proto.as = as;
            duration_prototype__proto.asMilliseconds =
                asMilliseconds;
            duration_prototype__proto.asSeconds =
                asSeconds;
            duration_prototype__proto.asMinutes =
                asMinutes;
            duration_prototype__proto.asHours = asHours;
            duration_prototype__proto.asDays = asDays;
            duration_prototype__proto.asWeeks = asWeeks;
            duration_prototype__proto.asMonths =
                asMonths;
            duration_prototype__proto.asYears = asYears;
            duration_prototype__proto.valueOf =
                duration_as__valueOf;
            duration_prototype__proto._bubble = bubble;
            duration_prototype__proto.get =
                duration_get__get;
            duration_prototype__proto.milliseconds =
                milliseconds;
            ...
            duration_prototype__proto.humanize =
                humanize;
            duration_prototype__proto.toISOString =
                iso_string__toISOString;
            duration_prototype__proto.toString =
                iso_string__toISOString;
            duration_prototype__proto.toJSON =
                iso_string__toISOString;
            duration_prototype__proto.locale = locale;
            duration_prototype__proto.localeData =
                localeData;
            ...
            utils_hooks__hooks.utc =
                create_utc__createUTC;
            utils_hooks__hooks.unix =
                moment__createUnix;
            utils_hooks__hooks.months =
                lists__listMonths;
            utils_hooks__hooks.isDate = isDate;
            utils_hooks__hooks.locale =
                locale_locales__getSetGlobalLocale;
            utils_hooks__hooks.invalid =
                valid__createInvalid;
            utils_hooks__hooks.duration =
                create__createDuration;
            utils_hooks__hooks.isMoment = isMoment;
            utils_hooks__hooks.weekdays =
                lists__listWeekdays;
            utils_hooks__hooks.parseZone =
                moment__createInZone;
            utils_hooks__hooks.localeData =
                locale_locales__getLocale;
            utils_hooks__hooks.isDuration = isDuration;
            utils_hooks__hooks.monthsShort =
                lists__listMonthsShort;
            utils_hooks__hooks.weekdaysMin =
                lists__listWeekdaysMin;
            utils_hooks__hooks.defineLocale =
                defineLocale;
            utils_hooks__hooks.weekdaysShort =
                lists__listWeekdaysShort;
            utils_hooks__hooks.normalizeUnits =
                normalizeUnits;
    ...
    <script type="text/javascript">
        ...
        Chart.prototype.init = function() {
            ...
            this.frontCanvas =
                document.createElement("canvas");
            this.bgCanvas.className =
                "ct-chart ct-chart-bg";
            this.mainCanvas.className =
                "ct-chart ct-chart-main";
            this.frontCanvas.className =
                "ct-chart ct-chart-front";
            ...
            this.candlesPerPage = Math.ceil(
                this.mainCanvas.clientWidth /
                (this.candlesFreeSpace * 2 +
                    this.candleWidth)
            );
            this.height = this.parent.clientHeight;
            this.width = this.parent.clientWidth;

            this.mousePosPrice = new PriceLine(
                this.mainCanvasCtx,
                this
            );
            this.mousePosTime = new TimeLine(
                this.mainCanvasCtx,
                this
            );
            var $this = this;
            ...
            this.imageEnd = new Image(); {
                ...
                buf.fillStyle = "#fff";
                buf.textAlign = "right";
                buf.fillText("Expiration time", 0, 17);
                ...
                buf.font = "13px Arial";
                buf.fillStyle = "#FF0000";
                buf.textAlign = "right";
                buf.fillText("Time expiration", -10, 17);
            ...
            var onWheel = function(e) {
                ...
                var delta =
                    e.deltaY || e.detail || e.wheelDelta;
                var mov = 1;
                if ($this.now - $this.lWheel < 1000) {
                    mov = Math.round(
                        1000 / ($this.now - $this.lWheel)
                    );
                    if (mov > 5) {
                        mov = 5;
                    }
                ...
                $this.candlesFreeSpaceTo = Math.round(
                    $this.candleWidthTo / 3
                );
        ...
        Chart.prototype.getX = function(time) {
            ...
            for (
                var i = 0; i < this.candlesShow.length; i++
            ) {
                var candle =
                    this.candlesShow[Math.round(s)];
                if (!candle && Math.round(s) === 1) {
                    s = 0;
                    continue;
                }
                if (
                    candle.timeId + 1000 > time &&
                    time >= candle.timeId
                ) {
                    return candle.posX;
        ...
        Chart.prototype.getY = function(price) {
            return (
                this.height -
                (price * this.pricePy - this.priceOffset)
            );
        };
        Chart.prototype.getPrice = function(y) {
            return (
                (this.height - y + this.priceOffset) /
                this.pricePy
            );
        };
        ...
        Chart.prototype.animate = function() {
            ...
            if (
                this.preparedOrder.symbol === "TRADE_OFF"
            ) {
                return;
            }

            this.candlesFreeSpace +=
                (this.candlesFreeSpaceTo -
                    this.candlesFreeSpace) /
                5;
            this.candleWidth +=
                (this.candleWidthTo - this.candleWidth) /
                5;
            this.candlesPerPage = Math.ceil(
                this.clientWidth /
                (this.candlesFreeSpace * 2 +
            ...
            if (
                ...
                this.preparedOrder.optionOff =
                    this.now + this.preparedOrder.timeFrame;
                this.preparedOrder.optionOff =
                    Math.round(
                        this.preparedOrder.optionOff / 1000
                    ) * 1000;
                this.preparedOrder.optionEnd = Math.round(
                    this.now +
                    this.preparedOrder.timeFrame -
                    this.preparedOrder.timeOff
                );
                this.preparedOrder.optionEnd =
                    Math.round(
                        this.preparedOrder.optionEnd / 1000
                    ) * 1000;
            }
            ...
            var text = moment(
                    this.preparedOrder.optionEnd - Date.now()
                )
                .utc()
                .format("mm:ss");
            this.mainCanvasCtx.font = "20px Arial";
            var w1 =
                this.mainCanvasCtx.measureText(
                    text
                ).width;
            this.mainCanvasCtx.fillStyle = "#F2F2F2";
            ...
            this.mainCanvasCtx.fillStyle = "#556E78";
            this.mainCanvasCtx.textAlign = "center";
            this.mainCanvasCtx.fillText(
                text,
                this.width / 2 - 2,
                30
            );
            ...
            if (closedOrd.length > 0) {
                ...
                var e2 =
                    document.getElementById("win_amt");
                e2.innerHTML = win;
            ...
            while (order) {
                if (!this.ordersClosed[order.endTime]) {
                    this.ordersClosed[order.endTime] =
                        new ClosedPosition(
                            this.mainCanvasCtx,
                            this,
                            order.endTime,
                ...
                this.ordersClosed[order.endTime].amount +=
                    order.profit;
                order = this.toOrdersClosed.pop();
            }
            for (var orderId in this.ordersClosed) {
                if (
                    this.ordersClosed.hasOwnProperty(
                        orderId
                    )
                ) {
            ...
            if (
                ...
                this.mousePosTime.draw(
                    this.getTime(this.mouseX)
                );
            }
            if (
                !this.dragging &&
        ...
        Chart.prototype.drawPrices = function() {
            ...
            ctx.font = "15px Arial";
            for (
                var py = step; py < this.height; py += step
            ) {
                ctx.beginPath();
                ctx.moveTo(0, py);
                ctx.lineTo(this.width, py);
                ctx.strokeStyle = "#D1E1E6";
                ctx.lineWidth = 1;
                ctx.setLineDash([4, 1]);
                ctx.stroke();
                ctx.beginPath();
                //ctx.fillStyle = "#788ba6";
                ctx.fillStyle = "#647A83    ";
                ctx.textAlign = "right";
                ctx.fillText(
                    this.getPrice(py).toFixed(5),
                    this.width - 10,
                    py - 5
                );
            }
        ...
        Chart.prototype.drawTimes = function() {
            ...
            for (
                var px = step; px < this.width; px += step
            ) {
                ctx.beginPath();
                ctx.moveTo(px, 20);
        ...
        Chart.prototype.drawCandles = function() {
            ...
            this.candlesShow = [];
            for (
                var ci = this.candlesOffset; ci >=
                this.candlesOffset -
                this.candlesPerPage && ci >= 0; ci--
            ) {
                var candle2 = this.candles[ci];
                if (candle2) {
                    this.candlesShow.push(candle2);
                } else {
                    this.candlesShow.push(
            ...
            if (
                ...
                if (
                    ...
                    this.speed -=
                        Math.abs(
                            lCandle.posX - this.width * 0.5
                        ) /
                        (this.candleWidth +
                            this.candlesFreeSpace * 2);
                } else if (
                    this.now - this.lastDraw >
                    1000
                ) {
                    this.lastDrag = this.now;
            ...
            if (this.minPrice && this.maxPrice) {
                this.minPrice -=
                    (this.minPrice - minPrice) / 5;
                this.maxPrice -=
                    (this.maxPrice - maxPrice) / 5;
            } else {
            ...
            this.priceOffset =
                this.minPrice * this.pricePy;
        };
        Chart.prototype.regClick = function(
            clickMe
        ) {
        ...
        Chart.prototype.onTick = function(tick) {
            ...
            if (
                candle &&
                candle.timeId ==
                Math.floor(tick.timeId / 1000) * 1000
            ) {
                if (candle.fake) {
                    candle.fake = false;
        ...
        Chart.prototype._addCandle = function(
            candle
        ) {
            var cn;
            ...
            if (this.candles.length == 0) {
                ...
                this.candles[0].timeId < cn.timeId
            ) {
                ...
                for (var i = 0; i < 30; i++) {
                    if (
                        this.candles[i] &&
                        this.candles[i].timeId == cn.timeId
                    ) {
        ...
        Chart.prototype.addCandles = function(
            candles
        ) {
            var $this = this;
        ...
        ClosedPosition.prototype.remove =
            function() {
                delete this.chart.ordersClosed[
                    this.endTime
                ];
            };
        ClosedPosition.prototype.draw = function() {
            var $this = this;
            this.ctx.save();
            ...
            var w = 120;
            var orX =
                this.chart.getX(this.endTime) + 10;
            if (orX <= 10 || !orX) {
                return;
            }
            var orY =
                this.chart.getY(this.endPrice) - h / 2;

            this.ctx.beginPath();

            this.ctx.beginPath();
            this.ctx.moveTo(10 + orX, orY);
            this.ctx.lineTo(w + orX, orY);
            ...
            this.ctx.lineTo(10 + w + orX, h + orY);
            this.ctx.quadraticCurveTo(
                10 + w + orX,
                10 + h + orY,
                w + orX,
            ...
            this.ctx.lineTo(10 + orX, 10 + h + orY);
            this.ctx.quadraticCurveTo(
                orX,
                10 + h + orY,
                orX,
            ...
            this.ctx.lineTo(orX, h / 2 + 10 + orY);
            this.ctx.lineTo(orX - 10, h / 2 + orY);
            this.ctx.lineTo(orX, h / 2 - 10 + orY);
            this.ctx.lineTo(orX, 10 + orY);
            this.ctx.quadraticCurveTo(
                orX,
                orY,
                10 + orX,
            ...
            this.ctx.strokeStyle = "#3ECDFF";
            this.ctx.lineWidth = 1;
            this.ctx.stroke();
            this.ctx.fillStyle = "#30B699";
            this.ctx.fill();

            this.ctx.beginPath();
            this.ctx.strokeStyle = "#fff";

            var clStartX = orX + w - 10;
            var clStartY = orY + 10;
            var clWidth = 10;
            var clHeight = 10;
            this.ctx.moveTo(clStartX, clStartY);
            this.ctx.lineTo(
                clStartX + clWidth,
                clStartY + clHeight
            );
        ...
        function EndLine(ctx, chart, config) {
            ...
            //this.lineStyle = "#fff";
            //this.bgStyle = "#445267";
            //this.lineName = this.chart.imageDed;
            if (config) {
                if (config.bgStyle) {}
                if (config.bgStyle) {
        ...
        EndLine.prototype.draw = function(
            ...
            if (this.displayTime) {
                ...
                this.ctx.fillText(text, tVal2, 25);
            }
        ...
        Candle.prototype.drawLine = function(
            ctx,
            chart,
            offset,
            nr,
            ...
            if (nr == 0) {
                ctx.beginPath();
                ctx.strokeStyle = "#17C3FD";
                ctx.lineWidth = 4;
                ctx.moveTo(
                    this.posX,
                    chart.getY(this.open)
                );
            }
            if (nr <= total - 1) {
                ctx.lineTo(
            ...
            if (nr == total - 1) {
                ...
                grd.addColorStop(0, "#BBECFC");
                grd.addColorStop(1, "#BBECFC");
                //grd.addColorStop(0, "#6796B0");
                //grd.addColorStop(1, "#445267");
                ctx.fillStyle = grd;
                ctx.lineTo(
                    chart.lastPosX,
                    chart.height - 20
                ...
                ctx.save();
                ctx.beginPath();
                ctx.shadowColor = "#556E78";
                ctx.fillStyle = "#556E78";
                if (chart.blurPlus) {
                    chart.blur += 40 / 60;
                    if (chart.blur > 20) {
        ...
        Candle.prototype.drawCandle = function(
            ctx,
            chart,
            offset
        ) {
            if (chart.candleWidth <= 4) {
                ctx.beginPath();
                ctx.lineWidth = 2;
                if (this.open > this.close) {
                    ctx.strokeStyle = "#9D5E6C";
                    ctx.fillStyle = "#9D5E6C";
                } else {
                    ctx.strokeStyle = "#50BDBE";
                    ctx.fillStyle = "#50BDBE";
                }
                ctx.moveTo(offset, chart.getY(this.min));
                ctx.lineTo(offset, chart.getY(this.max));
                ctx.stroke();
                return;
            }

            ctx.beginPath();
            ctx.strokeStyle = "#3ECDFF";
            ctx.lineWidth = 1;
            ...
            ctx.lineWidth = 1;
            if (this.open > this.close) {
                ctx.strokeStyle = "#AB4D55";
                ctx.fillStyle = "#AB4D55";
            } else {
                ctx.strokeStyle = "#50BDB2";
                ctx.fillStyle = "#50BDB2";
            }

            ctx.beginPath();
            var halfWidth = chart.candleWidth / 2;
            var closeY = chart.getY(this.close);
            var openY = chart.getY(this.open);

            ctx.moveTo(offset - halfWidth, closeY);
            ctx.lineTo(offset + halfWidth, closeY);
            ctx.stroke();

            ctx.beginPath();
            ctx.moveTo(offset - halfWidth, openY);
            ctx.lineTo(offset + halfWidth, openY);
            ctx.lineTo(offset + halfWidth, closeY);
            ctx.lineTo(offset - halfWidth, closeY);
            ctx.fill();
        ...
        ch = {
            link: function(element) {
                ...
                var preparedOrder = {
                    symbol: "EUR/USD",
                    optionOff: Math.round(Date.now() / 1000) * 1000 +
                        10000,
                    optionEnd: Math.round(Date.now() / 1000) * 1000 +
                        10000,
                    timeFrame: 10000,
                    timeOff: 0,
                };
                ...
                var pp = 109.77;
                var candlesAdd = [{
                    timeId: Math.round(Date.now() / 1000) *
                        1000,
                    close: pp,
                    open: pp,
                    min: pp,
                ...
                document.getElementById("Apple").onclick =
                    function() {
                        ...
                        chart.addCandles(candlesAdd);
                        var e1 =
                            document.getElementById("EURUSD");
                        var e2 =
                            document.getElementById("GAZPROM");
                        var e3 =
                            document.getElementById("Apple");
                        e1.className = e1.className.replace(
                            "ui-state-active",
                            ""
                        );
                        e2.className = e2.className.replace(
                            "ui-state-active",
                            ""
                        );
                        e3.className = e3.className +=
                            " ui-state-active";
                ...
                //            scope.$on('tick', function (ev, tick) {
                //                chart.onTick(tick);
                //            });
                //            scope.$on("order-save", function (ev, orders) {
                //                if (orders instanceof Array) {
                //                    for (var i = 0; i < orders.length; i++) {
                //                        var order = orders[i];
                //                        if (order.status === "STARTED" && order.symbol === symbol) {
                //                            if (order.rollNr > 0) {
                //                                for (var j = 0; j < chart.orders.length; j++) {
                //                                    if (chart.orders[j].id === order.id) {
                //                                        delete chart.orders[j];
                //                                    }
                //                                }
                //                            }
                //                            chart.orders.push(order);
                //                        } else if (order.status === "CLOSED" && order.symbol === symbol) {
                //                            chart.toOrdersClosed.push(order);
                //                        }
                //                    }
                //                } else if (orders.status === "STARTED" && orders.symbol === symbol) {
                //                    chart.orders.push(orders);
                //                } else if (orders.status === "CLOSED" && orders.symbol === symbol) {
                //                    chart.toOrdersClosed.push(orders);
                //                }
                //            });
                //            $http({
                //                method: 'GET',
                //                url: '/app-trade/cli/orders',
                //                params: {
                //                    limit: 100,
                //                    offset: 0,
                //                    symbol: symbol,
                ...
                //                }
                //            }).then(function (resp) {
                //                resp.data.hits.hits.forEach(function (i) {
                //                    chart.orders.push(i._source);
                //                });
                //            });
